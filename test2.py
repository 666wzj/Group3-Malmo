        ...
        try:
            ...
            while True:
                ...
                if len(world_state.observations) > 0:
                    ...
                    future_s = "%d:%d" % (int(obs[u'XPos']), int(obs[u'ZPos']))
                    if future_s == current_s:
                        self.q_table[self.prev_s][self.prev_a]=-10000
                    break
...
for x in range(0, 6):
    for z in range(0, 12):
        ...
        if ra < 0.1:
            ...
            my_mission.drawBlock(x, 46, z, "sandstone")
            if ra > 0.7:
